...
export const getAppointment = createAsyncThunk('calendarApp/events/getEvents', async () => {
...
const ordersSlice = createSlice({
  ...
  extraReducers: {
    [getEvents.fulfilled]: ordersAdapter.setAll,
    [removeEvent.fulfilled]: (state, action) => ordersAdapter.removeMany(state, action.payload),
  },
});
...
const eventsSlice = createSlice({
  ...
  reducers: {
    ...
    closeNewAppointmentDialog: (state, action) => {
      state.eventDialog = {
        type: 'new',
        props: {
          open: false,
  ...
  extraReducers: {
    ...
    [getAppointment.fulfilled]: eventsAdapter.setAll,
    [addAppointment.fulfilled]: eventsAdapter.addOne,
    [updateAppointment.fulfilled]: eventsAdapter.upsertOne,
    [removeAppointment.fulfilled]: eventsAdapter.removeOne,
  },
});
