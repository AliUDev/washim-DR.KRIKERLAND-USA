...
import { removeProducts } from "../store/diseasesSlice";
...
function DiseasesTableHead(props) {
                                        ...
                                        onClick={() => {
                                            dispatch(
                                                ...
                                                dispatch(
                                                    showMessage({
                                                        message:
                                                            "Disease Deleted successfully", //text or html
...
export default DiseasesTableHead