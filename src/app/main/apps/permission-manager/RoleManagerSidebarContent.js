...
function RoleManagerSidebarContent(props) {
        ...
        <div className="p-0 lg:p-24 lg:ltr:pr-4 lg:rtl:pl-4">
            ...
            >
                <div className="p-24 flex items-center">
                    <Typography className="mx-12">Role Management</Typography>
                </div>
...
export default RoleManagerSidebarContent;
