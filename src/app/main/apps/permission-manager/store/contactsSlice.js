...
export const getContacts = createAsyncThunk(
    ...
    async (routeParams, { getState }) => {
        ...
        const response = await axios.get(
            `${process.env.REACT_APP_WASHIM_BACKEND_URL}/api/permission-manager/all`,
            {
                params: routeParams,
            }
        );
...
export const addContact = createAsyncThunk(
    ...
    async (contact, { dispatch, getState }) => {
        ...
        const response = await axios.post(
            `${process.env.REACT_APP_WASHIM_BACKEND_URL}/api/role-manager/create`,
            {
                role: contact,
                userId: user.uuid,
            }
...
export const updateContact = createAsyncThunk(
    ...
    async (contact, { dispatch, getState }) => {
        const response = await axios.post(
            `${process.env.REACT_APP_WASHIM_BACKEND_URL}/api/permission-manager/update`,
            {
                permission: contact,
            }
        );
...
export const removeContact = createAsyncThunk(
    ...
    async (contactId, { dispatch, getState }) => {
        await axios.post(
            `${process.env.REACT_APP_WASHIM_BACKEND_URL}/api/role-manager/delete`,
            {
                roleId: contactId,
            }
        );
